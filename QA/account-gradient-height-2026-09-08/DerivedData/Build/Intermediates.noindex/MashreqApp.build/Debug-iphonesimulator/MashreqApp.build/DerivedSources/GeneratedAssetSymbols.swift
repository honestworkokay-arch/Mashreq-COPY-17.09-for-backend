...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let loginFaceContentOverlay = DeveloperToolsSupport.ImageResource(name: "LoginFaceContentOverlay", bundle: resourceBundle)
    ...
    static let loginReferenceGradient = DeveloperToolsSupport.ImageResource(name: "LoginReferenceGradient", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "LoginFaceContentOverlay" asset catalog image.
    static var loginFaceContentOverlay: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .loginFaceContentOverlay)
#else
        .init()
#endif
    }
    ...
    /// The "LoginReferenceGradient" asset catalog image.
    static var loginReferenceGradient: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .loginReferenceGradient)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "LoginFaceContentOverlay" asset catalog image.
    static var loginFaceContentOverlay: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .loginFaceContentOverlay)
#else
        .init()
    ...
    /// The "LoginReferenceGradient" asset catalog image.
    static var loginReferenceGradient: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .loginReferenceGradient)
#else
        .init()
